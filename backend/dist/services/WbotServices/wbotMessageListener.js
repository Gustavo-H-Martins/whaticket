...
const verifyMessage = (msg, ticket, contact) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield ticket.update({
        lastMessage: msg.type === "location" ?
            (msg.location && msg.location.description ?
...
const prepareLocation = (msg) => {
    ...
    msg.body += "|" + (msg.location && msg.location.description ? msg.location.description : (msg.location.latitude + ", " + msg.location.longitude));
    return msg;
};
