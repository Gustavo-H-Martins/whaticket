...
const verifyMessage = async (
  ...
  await ticket.update({
    lastMessage: msg.type === "location" ?
      (msg.location && (msg.location as any).description ?
        "Localization - " + (msg.location as any).description.split('\\n')[0] :
        "Localization") :
      msg.body
  });
...
const prepareLocation = (msg: WbotMessage): WbotMessage => {
  ...
  msg.body += "|" + (msg.location && (msg.location as any).description ? (msg.location as any).description : (msg.location.latitude + ", " + msg.location.longitude));
